            ...
            <div class="col-md-6">
                ...
                <div class="mb-2 d-flex">
                    ...
                    <div class="col-auto flex-grow-1">
                        ...
                        <span><a href="javascript:void(0)" class="text-dark btn-light fs-6 text-decoration-none update_status" data-status="<?php echo $status ?>"><i class="fa fa-edit"></i> Actualizar</a></span>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-2 d-flex">
                    <label for="" class="col-auto pe-1">Fecha de Creación: </label>
                ...
                <div class="mb-2 d-flex">
                    ...
                    <span><a href="javascript:void(0)" class="text-dark btn-light fs-6 text-decoration-none update_due" data-due="<?php echo $due_date ?>"><i class="fa fa-edit"></i> Actualizar</a></span>
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
    $(function(){
        $('.view_book').click(function(){
            uni_modal('Detalles de Libro',"view_book.php?borrowed_id=<?php echo $borrowed_id ?>&id="+$(this).attr('data-id'),"mid-large")
        })
        $('.update_status').click(function(){
            uni_modal_secondary('Actualizar Estado',"update_borrowed_status.php?id=<?php echo $borrowed_id ?>&status="+$(this).attr('data-status'))
        })
        $('.update_due').click(function(){
            uni_modal_secondary('Actualizar Fecha Devolución',"update_borrowed_due.php?id=<?php echo $borrowed_id ?>&due="+$(this).attr('data-due'))
        })
    })
</script>