...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Libería ConfiguroWeb</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'borrowed')? 'active' : '' ?>" href="./?page=borrowed">Préstamos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'admin')? 'active' : '' ?>" aria-current="page" href="./?page=admin">Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=maintenance">Mantenimiento</a>
                    </li>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item" href="../Actions.php?a=logout">Cerrar Sesión</a></li>
                </ul>
            </div>
            </div>
        </div>
